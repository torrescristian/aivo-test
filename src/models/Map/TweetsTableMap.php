...
class TweetsTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'tweets.id';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'tweets.created_at';

    /**
     * the column name for the text field
     */
    const COL_TEXT = 'tweets.text';

    /**
     * the column name for the in_reply field
     */
    const COL_IN_REPLY = 'tweets.in_reply';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(TweetsTableMap::COL_ID, TweetsTableMap::COL_CREATED_AT, TweetsTableMap::COL_TEXT, TweetsTableMap::COL_IN_REPLY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(TweetsTableMap::COL_ID => 0, TweetsTableMap::COL_CREATED_AT => 1, TweetsTableMap::COL_TEXT => 2, TweetsTableMap::COL_IN_REPLY => 3, ),
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TweetsTableMap::COL_ID);
            $criteria->addSelectColumn(TweetsTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(TweetsTableMap::COL_TEXT);
            $criteria->addSelectColumn(TweetsTableMap::COL_IN_REPLY);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(TweetsTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TweetsTableMap::COL_ID) && $criteria->keyContainsValue(TweetsTableMap::COL_ID) ) {
