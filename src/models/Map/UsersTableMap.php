...
class UsersTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_NAME => 1, ),
    ...
    {
        $this->addRelation('Tweets', '\\Tweets', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':in_reply',
    1 => ':id',
