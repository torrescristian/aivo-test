 ...
 *
 * @method     ChildUsersQuery leftJoinTweets($relationAlias = null) Adds a LEFT JOIN clause to the query using the Tweets relation
 * @method     ChildUsersQuery rightJoinTweets($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Tweets relation
 * @method     ChildUsersQuery innerJoinTweets($relationAlias = null) Adds a INNER JOIN clause to the query using the Tweets relation
 *
 * @method     ChildUsersQuery joinWithTweets($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Tweets relation
 *
 * @method     ChildUsersQuery leftJoinWithTweets() Adds a LEFT JOIN clause and with to the query using the Tweets relation
 * @method     ChildUsersQuery rightJoinWithTweets() Adds a RIGHT JOIN clause and with to the query using the Tweets relation
 * @method     ChildUsersQuery innerJoinWithTweets() Adds a INNER JOIN clause and with to the query using the Tweets relation
 *
 * @method     \TweetsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \Tweets object
     *
     * @param \Tweets|ObjectCollection $tweets the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($tweets instanceof \Tweets) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_ID, $tweets->getInReply(), $comparison);
            ...
            throw new PropelException('filterByTweets() only accepts arguments of type \Tweets or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \TweetsQuery A secondary query class using the current class as primary query
     */
    public function useTweetsQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinTweets($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Tweets', '\TweetsQuery');
    }
